...
function ENT:CannonTargeting(ground, sky)
	...
	timer.Simple(1.5, function() self:CannonTargeting2(ground, sky) end)
...
function ENT:CannonTargetingPerson(target, sky)
	...
	timer.Simple(1.5, function() self:CannonTargetingPerson2(target, sky) end)
...
function ENT:CannonTargeting2(ground, sky)
	...
	timer.Simple(1.5, function() self:CannonTargeting3(ground, sky) end)
...
function ENT:CannonTargetingPerson2(target, sky)
	...
	timer.Simple(1.5, function() self:CannonTargetingPerson3(target, sky) end)
...
function ENT:CannonTargeting3(ground, sky)
	...
	timer.Simple(3, function() self:GiantLaser(ground, sky) end)
...
function ENT:CannonTargetingPerson3(target, sky)
	...
	timer.Simple(3, function() self:GiantLaserPerson(target, sky) end)
...
function ENT:GiantLaser(ground, sky)	
	...
	timer.Simple(2.25, function() self:MassiveFuckingExplosion(ground, sky)	end)
...
function ENT:GiantLaserPerson(ground, sky)	
	...
	timer.Simple(2.25, function() self:MassiveFuckingExplosionPerson(ground, sky)	end)
	timer.Simple(1.5, function() for k, v in pairs (player.GetAll()) do 
