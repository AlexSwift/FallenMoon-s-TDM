...
SWEP.SlotPos				= 131			-- Position in the slot
...
SWEP.ViewModel				= "models/weapons/v_pist_glock18.mdl"	-- Weapon view model
...
-- Enter iron sight info and bone mod info below
	...
	SWEP.SightsPos = Vector(4.335, -2.52, 2.812)
	SWEP.SightsAng = Vector(0.912, 0.018, 0)
	SWEP.RunSightsPos = Vector(-2.595, -1.726, -0.401)
	SWEP.RunSightsAng = Vector(-5.638, -10.094, 0)

if not (IsMounted("cstrike")) then 
	SWEP.Spawnable				= false
	SWEP.AdminSpawnable			= false
	SWEP.ViewModel = "models/weapons/2_pist_glock18.mdl"	-- Weapon view model
	SWEP.Primary.Sound			= Sound("Alt_Weapon_Glock.1")
