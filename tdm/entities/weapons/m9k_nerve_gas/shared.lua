...
SWEP.SlotPos				= 110			-- Position in the slot
...
SWEP.VElements = {
	["nerve"] = { type = "Model", model = "models/healthvial.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(-0.076, 0.241, 0.063), angle = Angle(-17.351, -8.782, -99.301), size = Vector(0.708, 0.708, 0.708), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/gv/nerve_vial.vmt", skin = 0, bodygroup = {} }
}
