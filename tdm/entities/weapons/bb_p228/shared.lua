...
SWEP.SlotPos				= 137			-- Position in the slot
...
SWEP.ViewModel				= "models/weapons/v_pist_p228.mdl"	-- Weapon view model
...
-- Enter iron sight info and bone mod info below
	SWEP.IronSightsPos = Vector(4.75, 0, 2.898)
...
if not(IsMounted("cstrike")) then 
	...
	SWEP.Primary.Sound			= Sound("Alt_Weapon_P228.1")
