...
SWEP.SlotPos				= 150			-- Position in the slot
...
-- SWEP.WElements = {
	-- ["bottle"] = { type = "Model", model = "models/props_junk/glassbottle01a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.247, 2.127, -2.31), angle = Angle(-166.646, -9.619, -15.37), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/nitro/nitro.vmt", skin = 0, bodygroup = {} }
-- }

-- SWEP.VElements = {
	-- ["nitroglass"] = { type = "Model", model = "models/props_junk/glassbottle01a.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.151, -0.974, 0.243), angle = Angle(-30.781, -12.855, 65.231), size = Vector(0.681, 0.681, 0.681), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/nitro/nitro.vmt", skin = 0, bodygroup = {} }
-- }

-- SWEP.ViewModelBoneMods = {
	-- ["v_weapon.Left_Thumb03"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(4.343, 24.655, 0) },
	-- ["v_weapon.Left_Thumb01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-3.748, 11.178, 0) }
-- }

SWEP.VElements = {
	["bottle_o_boom"] = { type = "Model", model = "models/weapons/w_nitro.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(-5.765, -8.132, -16.716), angle = Angle(160.58, -12.247, 97.574), size = Vector(0.771, 0.771, 0.771), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
