...
SWEP.SlotPos				= 119			-- Position in the slot
...
if not(IsMounted("cstrike")) then 
	...
	SWEP.Primary.Sound = Sound("Alt_Weapon_ELITE.1")
	SWEP.ViewModel = "models/weapons/2_pist_elite.mdl"	-- Weapon view model
	SWEP.ShowWorldModel	= true --i'll fix it when I feel like it. At least you have a gun. 
end
