...
SWEP.SlotPos				= 133			-- Position in the slot
...
elseif GetConVar("M9KUnified_CSS_vms"):GetBool() then
	...
	SWEP.ViewModelFlip = false --should have left it as original, and let everybody do as little change to the coding as necessary. But no, you just had to go and screw with the viewmodel.
