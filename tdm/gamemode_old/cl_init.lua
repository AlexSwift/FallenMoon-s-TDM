...
function mainMenuScreen( ply )

GetCredits = ply:GetNWInt("credit")
GetGold = ply:GetNWInt("gold")
	...
	mainMenu.Paint = function()
		...
		// Double it to make a deaper and darker feal to the load screen
		draw.RoundedBox( 4, 0, 0, ScrW(), ScrH(), Color( 10, 10, 10, 250 ) )
	end
...
concommand.Add("MainMenu", mainMenuScreen)